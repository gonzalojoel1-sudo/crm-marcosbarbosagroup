...
for org, status, value, date, step in DEALS:
    ...
    d = frappe.get_doc({"doctype":"CRM Deal","organization":o,"status":status,"deal_value":value,"currency":"USD","expected_closure_date":date,"next_step":step,"deal_owner":"Administrator"})
